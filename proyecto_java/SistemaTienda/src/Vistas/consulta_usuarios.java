...
public class consulta_usuarios extends javax.swing.JFrame {
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        try {
            ...
            String sql = "SELECT USUARIOSID, USUARIO, PASSWORD, NOMBREU, CORREO,LAST_SESSION, NOMBRET FROM usuarios INNER JOIN TIPO_USUARIOS ON USUARIOS.ID_TIPO=TIPO_USUARIOS.ID; " + where;
            ...
            modelo.addColumn("Contraseña");
             ...
             modelo.addColumn("Ultima Session");        
